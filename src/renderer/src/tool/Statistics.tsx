...
export const Statistics = () => {
    ...
    return <div className="tool-statistics assignment-manage" style={{height: "100%"}}>
        <div className="title">
            <Tab tabs={[
                ["input", "输入"],
                ["output", "输出"],
            ...
            />: <div>
                <div>
                    <div className="progress">
                        <div className="bar" style={{ width: `${trues / students.length * 100}%` }} />
                        <span>{trues} / {students.length}
                        ({Math.round(trues / students.length * 100)}%)</span>
                    </div>
                </div>
                <div>
                    ...
                    <div className="unsubmitted">
                        {(() => {
                            const target = students.filter(student => inversed != data[student.id])
